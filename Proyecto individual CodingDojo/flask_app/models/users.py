...
class User:
    ...
    def save(cls, formulario):
        query = "INSERT INTO users (first_name, last_name, kind_of_user, email, password, life) VALUES (%(first_name)s, %(last_name)s, %(kind_of_user)s, %(email)s, %(password)s, %(life)s)"
